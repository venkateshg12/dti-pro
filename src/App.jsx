...
const App = ({ onNavigate }) => {
  return (
    <div className="w-full h-full overflow-hidden bg-black text-white font-sans">
      {/* Fixed Top Banner */}
      ...
      <section className="h-screen w-full relative  bg-gradient-to-r from-blue-900 to-gray-900">
        {/* The animation as background */}
        <div className="absolute inset-0 z-0  opacity-[0.4]">
          <MixedImageAnimation className="w-full h-full" />
        </div>
        <div className="bg-opacity-60 p-10 md:p-7 w-full max-w-6xl rounded-lg z-20">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div className="max-w-[16rem] p-5 bg-gray-800/70 backdrop-blur-2xl">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-right">Ahead</h2>
            </div>
          </div>
        </div>
      ...
      {/* Get Started Section */}
      <section className="min-h-screen w-full py-16 bg-gradient-to-br from-blue-500 via-red-500 to-blue-500">
        <div className="bg-black bg-opacity-60 p-10 md:p-6 w-full max-w-4xl rounded-lg text-center">
